...
module.exports = async (req, res, next) => {
    try {
        ...
        if (!await accountController.getAccountByEmail(req.body.accountMail)){
            ...
            const token = jwt.sign(tokenAccount, process.env.tokenkey, {expiresIn: '2h'});
        ...
        return res.status(500).json({
            error : "Erreur serveur dans l'envoi de la réinitialisation de mot de passe" + error
        });
    }
};
